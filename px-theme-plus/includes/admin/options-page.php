...
function up_plugins_options_page() {
  ...
  ?>
  <div class="wrap">
    <h1><?php esc_html_e('px-theme Plus Settings', 'px-theme-plus' ); ?></h1>
    <?php
    ...
    if(isset($_GET['status']) && $_GET['status'] == '1') {
      ...
      <div class="notice notice-success inline">
        <p>
          <?php esc_html_e('Options updated successfully!', 'px-theme-plus'); ?>
        </p>
      </div>
      <?php
    }
    ...
    <form novalidate="novalidate" method="POST" action="admin-post.php">
      ...
      <table class="form-table">
        <tbody>
          ...
          <tr>
            <th>
              <label for="up_og_title">
                <?php esc_html_e('Open Graph Title', 'px-theme-plus'); ?>
              </label>
            </th>
            <td>
          ...
          <tr>
            <th>
              <label for="up_og_image">
                <?php esc_html_e('Open Graph Image', 'px-theme-plus'); ?>
              </label>
            </th>
            <td>
          ...
          <tr>
            <th>
              <label for="up_og_description">
                <?php esc_html_e('Open Graph Description', 'px-theme-plus'); ?>
              </label>
            </th>
            <td>
              <textarea 
          ...
          <tr>
            <th>
              <?php esc_html_e('Open Graph', 'px-theme-plus'); ?>
            </th>
            <td>
