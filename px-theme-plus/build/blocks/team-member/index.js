...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__({
  ...
  const imageClass = `wp-image-${imgID} img-${context["px-theme-plus/image-shape"]}`;
  const [activeSocialLink, setActiveSocialLink] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)(null);
  setAttributes({
    imageShape: context["px-theme-plus/image-shape"]
  });
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, imgPreview && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
    ...
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Replace Image", "px-theme-plus"),
    mediaId: imgID,
    mediaURL: imgURL,
    allowedTypes: ["image"],
    accept: "image/*",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Remove Image", "px-theme-plus"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Settings", "px-theme-plus")
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Alt Attribute", "px-theme-plus"),
    value: imgAlt,
    onChange: imgAlt => setAttributes({
      imgAlt
    }),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Description of your image for screen readers.", "px-theme-plus")
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Name", "px-theme-plus"),
    tagName: "strong",
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Title", "px-theme-plus"),
    tagName: "span",
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Member bio", "px-theme-plus"),
    tagName: "p",
    ...
    text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Add Social Media Handle", "px-theme-plus")
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("URL", "px-theme-plus"),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Icon", "px-theme-plus"),
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Remove", "px-theme-plus")))));
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  secundary: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    viewBox: "0 0 95.47 98.99",
    xmlns: "http://www.w3.org/2000/svg"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("g", {
    fill: "#000"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m39.39 12.62h-9.56c-1.15-1.53-2.5-2.68-4.05-3.45s-3.32-1.15-5.31-1.15c-3.38 0-6.25 1.24-8.61 3.72s-3.55 5.49-3.55 9.01 1.19 6.57 3.57 9.04c2.38 2.46 5.28 3.7 8.69 3.7 1.86 0 3.58-.37 5.15-1.12s2.85-1.8 3.83-3.15h9.47c-1.84 4.07-4.31 7.13-7.39 9.17-3.09 2.04-6.79 3.07-11.12 3.07-5.71 0-10.52-2.01-14.4-6.04-3.88-4.02-5.83-9-5.83-14.94 0-2.77.53-5.41 1.59-7.91s2.6-4.76 4.63-6.79c1.92-1.9 4.06-3.34 6.42-4.31 2.36-.98 4.92-1.46 7.65-1.46 4.34 0 8.06 1.04 11.16 3.11 3.09 2.07 5.65 5.24 7.65 9.52z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m54.18 40.67h-7.64v-39.88h7.37l16.54 25.47v-25.47h7.61v39.87h-7.23l-16.65-26.23v26.23z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m66.82 85.35h-20.18v-39.87h7.75v32.86h12.43z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m70.76 85.35v-39.87h10.19c3.58 0 6.48.99 8.69 2.97 2.22 1.98 3.33 4.54 3.33 7.68 0 1.86-.35 3.45-1.05 4.76s-1.72 2.31-3.05 2.99c1.93.55 3.47 1.67 4.61 3.35 1.14 1.69 1.71 3.67 1.71 5.96 0 2.08-.42 3.99-1.25 5.72s-2 3.13-3.52 4.19c-1.15.8-2.42 1.38-3.82 1.72-1.4.35-3.35.52-5.87.52h-9.97zm7.5-23.82h.9c2.19 0 3.8-.4 4.83-1.19s1.55-2.03 1.55-3.71c0-1.37-.51-2.4-1.53-3.09s-2.55-1.04-4.57-1.04h-1.18v9.04zm0 16.81h2.36c2.35 0 4.09-.4 5.22-1.19 1.12-.79 1.68-2.02 1.68-3.68 0-1.79-.59-3.15-1.77-4.09s-2.89-1.41-5.13-1.41h-2.36v10.38z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m28.18 46.6-6.76 6.76c-1.9-.27-3.67-.13-5.31.43s-3.16 1.54-4.57 2.94c-2.39 2.39-3.54 5.3-3.46 8.72.08 3.43 1.37 6.39 3.86 8.88 2.52 2.52 5.49 3.8 8.92 3.86s6.35-1.12 8.76-3.53c1.32-1.32 2.27-2.79 2.85-4.43s.74-3.29.48-4.94l6.7-6.7c1.57 4.18 1.99 8.09 1.26 11.71-.74 3.63-2.63 6.97-5.69 10.03-4.04 4.04-8.86 6.01-14.45 5.92-5.6-.1-10.49-2.24-14.69-6.44-1.96-1.96-3.45-4.2-4.47-6.72s-1.53-5.21-1.53-8.07c.01-2.7.51-5.23 1.49-7.59s2.44-4.51 4.38-6.45c3.07-3.07 6.44-4.97 10.09-5.69s7.7-.28 12.14 1.32z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m7.42 93.13h-.91c-.35-.48-.73-.83-1.16-1.06-.42-.22-.91-.34-1.45-.34-.86 0-1.6.32-2.2.95-.61.64-.91 1.4-.91 2.3s.3 1.67.92 2.31c.61.64 1.34.95 2.2.95.53 0 1.01-.11 1.44-.33.42-.22.8-.55 1.12-.99h.9c-.36.67-.83 1.17-1.42 1.53s-1.27.53-2.03.53c-1.1 0-2.03-.39-2.78-1.16s-1.12-1.74-1.12-2.88c0-.54.1-1.05.31-1.53.2-.48.5-.92.89-1.3.37-.37.78-.65 1.23-.83.45-.19.94-.28 1.47-.28.76 0 1.45.19 2.06.56s1.09.9 1.46 1.59z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m8.69 91.14h.75v7.69h-.75z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m11.13 91.14h.91l4.15 6.77v-6.77h.73v7.69h-.91l-4.15-6.78v6.78h-.72v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m18.66 91.14h4v.73h-3.25v2.72h3.24v.73h-3.24v2.76h3.24v.73h-3.99v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m31.37 93.13h-.91c-.35-.48-.73-.83-1.16-1.06-.42-.22-.91-.34-1.45-.34-.86 0-1.6.32-2.2.95-.61.64-.91 1.4-.91 2.3s.3 1.67.92 2.31c.61.64 1.34.95 2.2.95.53 0 1.01-.11 1.44-.33.42-.22.8-.55 1.12-.99h.9c-.36.67-.83 1.17-1.42 1.53s-1.27.53-2.03.53c-1.1 0-2.03-.39-2.78-1.16s-1.12-1.74-1.12-2.88c0-.54.1-1.05.31-1.53.2-.48.5-.92.89-1.3.37-.37.78-.65 1.23-.83.45-.19.94-.28 1.47-.28.76 0 1.45.19 2.06.56s1.09.9 1.46 1.59z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m32.79 91.14h.76v6.94h2.7v.74h-3.46v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m37.61 91.14h.75v4.62c0 .5.02.86.07 1.08.04.22.12.42.21.58.16.25.36.44.6.58s.52.2.82.2.58-.07.83-.2c.25-.14.45-.33.6-.57.1-.17.17-.36.22-.58.04-.22.06-.58.06-1.08v-4.62h.75v4.89c0 1-.2 1.74-.59 2.23-.4.49-1 .73-1.81.73-.86 0-1.49-.24-1.9-.72s-.61-1.23-.61-2.24v-4.89z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m44.4 91.14h1.64c.72 0 1.28.19 1.7.56s.62.88.62 1.51c0 .33-.06.62-.2.87s-.32.45-.57.61c.36.12.65.34.86.66s.32.69.32 1.13c0 .77-.22 1.36-.67 1.76s-1.11.6-2 .6h-1.71v-7.69zm.72.73v2.59h.46c.74 0 1.26-.1 1.56-.31.3-.2.44-.54.44-1.01 0-.42-.14-.74-.43-.95-.28-.21-.71-.32-1.28-.32zm0 3.32v2.9h1.07c.62 0 1.08-.12 1.38-.35.3-.24.45-.6.45-1.09s-.15-.85-.46-1.09-.77-.36-1.38-.36h-1.06z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m55.48 91.14h.92l2.96 7.69h-.81l-.91-2.41h-3.43l-.92 2.41h-.79l2.97-7.69zm.44.72-1.45 3.86h2.91z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m60.71 91.14h.76v6.94h2.7v.74h-3.46v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m65.71 91.14h1.11l2.65 6.68 2.66-6.68h1.1v7.69h-.72v-6.79l-2.7 6.79h-.67l-2.7-6.79v6.79h-.73z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m75.02 91.14h4v.73h-3.25v2.72h3.24v.73h-3.24v2.76h3.24v.73h-3.99v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m80.52 91.14h2.06c.91 0 1.62.21 2.11.62.5.41.74 1 .74 1.76 0 .62-.18 1.15-.53 1.58s-.8.67-1.35.72l1.88 3h-.92l-2.27-3.71h.72c.49 0 .88-.14 1.19-.43s.46-.65.46-1.1c0-.6-.17-1.04-.51-1.3-.34-.27-.92-.4-1.74-.4h-1.1v6.93h-.75v-7.69z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m87.61 88.55h.8l-1.43 1.85h-.49l1.11-1.85zm-.84 2.59h.75v7.69h-.75z"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    d: "m91.59 91.14h.92l2.96 7.69h-.81l-.91-2.41h-3.43l-.92 2.41h-.79l2.97-7.69zm.44.72-1.45 3.86h2.91z"
  })))
});
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('px-theme-plus/team-member', {
  icon: {
