    ...
    <>
      {imgPreview && (
        <BlockControls group="inline">
          <MediaReplaceFlow
            name={__("Replace Image", "px-theme-plus")}
            mediaId={imgID}
            mediaURL={imgURL}
            allowedTypes={["image"]}
            accept={"image/*"}
      ...
      <InspectorControls>
        <PanelBody title={__("Settings", "px-theme-plus")}>
          {imgPreview && !isBlobURL(imgPreview) && (
            <TextareaControl
              label={__("Alt Attribute", "px-theme-plus")}
              value={imgAlt}
      ...
      <div {...blockProps}>
        <div className="author-meta">
          ...
          <p>
            <RichText
              placeholder={__("Name", "px-theme-plus")}
              tagName="strong"
              onChange={(name) => setAttributes({ name })}
              value={name}
            />
            <RichText
              placeholder={__("Title", "px-theme-plus")}
              tagName="span"
        ...
        <div className="member-bio">
          <RichText
            placeholder={__("Member bio", "px-theme-plus")}
            tagName="p"
        ...
        <div className="social-links">
          ...
          {isSelected && (
            <Tooltip text={__("Add Social Media Handle", "px-theme-plus")}>
              <a
                href="#"
                onClick={(event) => {
                  event.preventDefault();
